package it.interno.caratteristichepersonafisica.aspect;
...
@Component
@Log4j2
public class CaratteristichePersonaFisicaLogger {

    private static final String POINTCUT = "within(it.interno.caratteristichepersonafisica.controller.*)";
